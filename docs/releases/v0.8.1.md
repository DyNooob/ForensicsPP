...
- `ForensicsPP-v0.8.1-static.zip`：构建好的纯静态网站，可部署到 Loken 静态托管、Nginx、Apache、对象存储或其他静态托管服务。
...
- `ForensicsPP-v0.8.1-static.zip`: pre-built static files for Loken static hosting, Nginx, Apache, object storage, or another static host.
